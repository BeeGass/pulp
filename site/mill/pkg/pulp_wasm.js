 ...
 * @returns {string}
 */
export function pulp_version() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.pulp_version();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {any}
 */
export function scan_files(input) {
    const ret = wasm.scan_files(input);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function smoke_pack() {
    const ret = wasm.smoke_pack();
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('pulp_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
